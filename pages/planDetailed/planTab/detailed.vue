		...
		<view class="body-info">
			...
			<view class="box-style">
				<uni-list>
					...
					<uni-list-item>
						<view class="photo" @click="upload" v-if='!uploadImg&&!img_path'>
						       <!-- <image :src="img_path" mode="" v-if="img_path!=''" style="width: 100%;height: 100%;"></image> -->
						       <view class="squ">
						        <image src="../../../static/images/camera.png" mode="" class="ppp"></image>
						        <view class=" tianjia" >添加照片</view>
						       </view>
						  </view>
						  <!-- style="padding: 70rpx;box-sizing: border-box;" -->
						  <view class="photo" v-if="uploadImg||img_path">
						  	 <image :src="img_path" mode="" style="width: 100%;height: 100%;" v-if="img_path"  @click="upload"></image>
							 <view style="width: 100%;height: 100%;padding: 70rpx;box-sizing: border-box;" v-if="uploadImg">
							 	<image src="../../../static/images/load.gif" mode="" style="width: 100%;height: 100%;"></image>
							 </view>
						  </view>
					</uni-list-item>
				</uni-list>
