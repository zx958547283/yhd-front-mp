  ...
  <div class="evaluation">
    <div class="content">
      <div class="question">
        ...
        <button :style="{backgroundColor:answer === 1 ? '#c59a76':'white', color:answer === 1 ? '#ffffff':'#000000'}" @click.native="changeQuestion(1)">{{answerNow[0]}}</button>
        <button :style="{backgroundColor:answer === 2 ? '#c59a76':'white', color:answer === 2 ? '#ffffff':'#000000'}" @click.native="changeQuestion(2)">{{answerNow[1]}}</button>
        <button :style="{backgroundColor:answer === 3 ? '#c59a76':'white', color:answer === 3 ? '#ffffff':'#000000' }" @click.native="changeQuestion(3)">{{answerNow[2]}}</button>
        <button :style="{backgroundColor:answer === 4 ? '#c59a76':'white', color:answer === 4 ? '#ffffff':'#000000' }" @click.native="changeQuestion(4)">{{answerNow[3]}}</button>
        <button :style="{backgroundColor:answer === 5 ? '#c59a76':'white', color:answer === 5 ? '#ffffff':'#000000' }" @click.native="changeQuestion(5)">{{answerNow[4]}}</button>
      </div>
  ...
  methods: {
    ...
    submitAnswer(num) {
      ...
      pakTool.request(this, "/tcm/saveAnswerRecord", requestPak).then((res) => {
        // {"ok":true,"message":"","pk":null,"code":"200","data":"d46c957b-cabf-4ea2-a084-1b423b89ef77"}
