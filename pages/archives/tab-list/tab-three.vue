    ...
    <view class="" v-for="(item,index) in listArr" :key='index'>
      ...
      <view class="pressure" style="margin-top: 10rpx;" v-for="(i,ind) in item.listInfo" :key='ind' v-if="showlist==item.care_num">
        ...
        <view class="main">
          ...
          <view class="main_right" @click="enter(i.id,i.care_plan_id)">
  ...
  methods: {
    ...
    getmessage() {
      ...
      pakTool
        ...
        .then((res) => {
          // {"ok":true,"message":"","pk":null,"code":"200","data":[{"member_id":"b0e964f2-384d-4dc8-91fd-3b45bb7b60de","img_path":"http://xiaode.oos-cn.ctyunapi.cn/20200727/png/yhd/upload/202007271509124277602.png","care_project_name":"元化灸","record_no":"000001","comment":"46","id":"6f6ae151-f9f5-455f-aa9c-4bf124589d90","care_plan_id":"c32a7e3a-e9c3-4b33-b36b-73d0b88a173a","record_time":"2020-07-27","care_num":"000002","username":"B1健康专员"},{"member_id":"b0e964f2-384d-4dc8-91fd-3b45bb7b60de","img_path":"http://xiaode.oos-cn.ctyunapi.cn/20200727/png/yhd/upload/202007271453263689400.png","care_project_name":"元化灸","record_no":"000001","comment":"理疗建议","id":"63de19a3-1f68-4fe1-99c1-0ca547eb736f","care_plan_id":"f4e04c2d-0614-428a-ac42-e668ae36f173","record_time":"2020-07-27","care_num":"000001","username":"B1健康专员"}]}
          const { data } = res;
