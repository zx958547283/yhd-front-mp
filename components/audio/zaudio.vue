<template>
	<view class="imt-audio" :class="[`${theme}`]" style="position: relative;">
		<view class="top"  >
			<view class="audio-control-wrapper">
				<!-- <image :src="info.coverImgUrl" mode="aspectFill" class="cover" :class="{ on: !paused }" ></image> -->
				<image src="../../static/learn/begin.png" alt="" @click="operation" class="play" v-if="paused" ></image>
				<image src="../../static/learn/stop.png" alt="" @click="operation" class="play" v-else ></image>
			</view>
			...
			<view v-if="duration!='00:00'" class="audio-number" style="position: absolute;left: 140rpx;bottom: 10rpx;">{{ current }}/{{ duration }}</view>
